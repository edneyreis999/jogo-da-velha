...
export class HUDScene extends Phaser.Scene {
  ...
  create() {
    ...
    level.events.on(EEVENTS.TILE_OCCUPIED, this.updateTileOcupation, this);
    level.events.on(EEVENTS.TOGGLE_TURN, this.displayToggleTurnMessage, this);
    level.events.on(EEVENTS.HAS_WINNER, this.displayWinner, this);
    level.events.on(EEVENTS.GAME_TIED, this.displayTie, this);
  }
